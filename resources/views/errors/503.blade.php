                            ...
                            <div class="card">
                                <div class="card-body p-0 auth-header-box">
                                    <div class="text-center p-3">
                                        ...
                                        <h4 class="mt-3 mb-1 fw-semibold text-white font-18">Oops! Halaman yg kamu tuju dalam perbaikan</h4>   
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="ex-page-content text-center">
                                        <h1 class="mt-5 mb-4">503!</h1>  
                                        <h5 class="font-16 text-muted mb-5">Service Sedang Dalam Perbaikan.</h5>                                    
                                    </div>          
                                </div><!--end card-body-->

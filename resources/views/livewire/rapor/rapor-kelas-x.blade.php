...
<div class="page-content-tab">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{ url('/'.strtolower(Auth::user()->role->role).'/rapor/kelas/X/create') }}" class="btn btn-primary">Tambah data</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/'.strtolower(Auth::user()->role->role).'/rapor/kelas/X/'.$rapor->user_id.'/'.$rapor->uuid.'/show') }}" class="btn btn btn-success" wire:navigate><i class="fas fa-eye"></i></a>

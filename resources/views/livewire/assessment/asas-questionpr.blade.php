                ...
                <div class="card shadow">
                    ...
                    <div class="card-body p-0">    
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a href="{{ url('guru/assessment/asas/input-soal/pg/'.$uuid) }}" class="nav-link" wire:navigate>Soal PG</a>
                            </li>
                            <li class="nav-item">
                                                    ...
                                                    <div class="col-lg-12 col-xl-12">
                                                        @foreach($pg_question as $key => $pg)
                                                            <p>{{ $key + 1 }} {{ $pg->pgquestion }} 
                                                                <a href="{{ url('/guru/assessment/asas/edit-soal/pg/'.$pg->uuid) }}" class="badge bg-success"><i class="fas fa-edit"></i></a>
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <p>{{ $key + 1 }}.{{ $essay->question }} 
                                                            <a href="{{ url('/guru/assessment/asas/edit-soal/essay/'.$essay->uuid) }}" class="badge bg-success"><i class="fas fa-edit"></i></a>

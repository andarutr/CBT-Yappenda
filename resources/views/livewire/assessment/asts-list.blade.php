@section('title', 'Assessment Sumatif Tengah Semester')
...
<div class="page-content-tab">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-2">
                <a href="/{{ Request::segment(1) }}/assessment/asts/create" class="btn btn-primary" wire:navigate>Tambah data</a>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="blog-card">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="align-self-center">
                                    <a wire:click="destroy('{{ $ass->uuid }}')" class="btn btn-sm btn-danger rounded-circle" wire:confirm="Yakin ingin menghapus ASTS?"><i class="fas fa-trash"></i></a>&nbsp;
                                    <a href="{{ url('/'.Request::segment(1).'/assessment/asts/input-soal/pg/'.$ass->uuid) }}" class="btn btn-sm btn-primary rounded-circle"><i class="fas fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <!--end blog-card-->

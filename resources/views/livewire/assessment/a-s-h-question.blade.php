                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">    
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if($status_panel == 'pg') active @endif" data-bs-toggle="tab" href="#SoalPG" role="tab" aria-selected="false">Soal PG</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if($status_panel == 'essay') active @endif" data-bs-toggle="tab" href="#SoalEssay" role="tab" aria-selected="false">Soal Essay</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane p-3 @if($status_panel == 'pg') active @endif" id="SoalPG" role="tabpanel">
                                <div class="row">
                            ...
                            <div class="tab-pane p-3 @if($status_panel == 'essay') active @endif" id="SoalEssay" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-8 col-xl-8">
                                        @if(session('success'))
                                        <div wire:transition>

        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="max-width: 10px">
                    <button class="btn btn-sm btn-success" wire:click="edit('{{ $ash->uuid }}')"><i class="bi-pencil-fill"></i></button>
                </td>
                <td style="max-width: 10px">
                    <button class="btn btn-sm btn-danger" wire:click="destroy('{{ $ash->uuid }}')" wire:confirm="Yakin ingin menghapus data?"><i class="bi-trash"></i></button>
                </td>
            </tr>
            @endforeach
        </tbody>

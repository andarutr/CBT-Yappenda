...
$assessment = computed(function(){
    return Exam::where('exam_type','ASH')->orderByDesc('start_time')->get();
});
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card-footer">
                ...
                <a href="{{ url('/'.strtolower(Auth::user()->role->role).'/assessment/ash/input-soal/pg/'.$ass->uuid) }}" class="btn btn-sm btn-primary rounded-circle"><i class="bi-plus"></i></a>

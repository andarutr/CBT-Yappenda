...
title('List Assessment Tengah Semester');
...
$assessment = computed(function(){
    return Exam::where('exam_type','ASTS')->orderByDesc('start_time')->get();
});
...
$destroy = function($uuid){
    ...
    return redirect('/'.strtolower(Auth::user()->role->role).'/assessment/asts');
};
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card-footer">
                ...
                <a href="{{ url('/'.strtolower(Auth::user()->role->role).'/assessment/asts/input-soal/pg/'.$ass->uuid) }}" class="btn btn-sm btn-primary rounded-circle"><i class="bi-plus"></i></a>

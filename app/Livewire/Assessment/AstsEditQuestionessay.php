...
class AstsEditQuestionessay extends Component
{
    public $uuid;
    public $question;
    public $redirect_url;
    ...
    public function mount()
    {
        ...
        $this->redirect_url = '/guru/assessment/asts/input-soal/essay/'.$redirect->uuid;
    }
    ...
    {
        return view('livewire.assessment.asts-edit-questionessay');
    }
}

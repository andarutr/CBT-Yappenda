...
class AsasEditQuestionpg extends Component
{
    public $uuid;
    public $question; 
    public $pgquestion;
    ...
    public function mount()
    {
        ...
        $this->redirect_url = '/guru/assessment/asas/input-soal/pg/'.$redirect->uuid;
    }
    ...
    {
        return view('livewire.assessment.asas-edit-questionpg');
    }
}
